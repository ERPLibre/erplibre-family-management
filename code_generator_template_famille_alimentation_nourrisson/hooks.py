...
MODULE_NAME = "code_generator_famille_alimentation_nourrisson"
...
def post_init_hook(cr, e):
    with api.Environment.manage():
        ...
        value["template_model_name"] = "famille.alimentation.nourrisson"
        ...
        # Add dependencies
        lst_depend_module = ["code_generator", "code_generator_hook", "code_generator_portal"]
